...
public class PostgresqlInsertStatementBuilder {
    ...
    private List<Pair> valueColumnNamePairsToInsert = new ArrayList<>();
    ...
    public PostgresqlInsertStatementBuilder insert(String value, String columnName) {
        valueColumnNamePairsToInsert.add(new Pair(columnName, value));
        return this;
    }
    ...
    private String generateColumnDescriptions() {
        return generateParameterDescription(param -> surroundWithDoubleQuotes(param.getColumnName()));
    }
    ...
    private String generateParameterDescription(Function<Pair, String> mapperFunction) {
